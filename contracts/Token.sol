...
contract Token is TokenInterface {
    ...
    uint256 public totalSupply;
  	...
  	function Token(address _superVotingContract) {
    		superVotingContract = _superVotingContract;
    }

    function transfer(address _to, uint256 _value) notLocked(msg.sender) returns (bool success) {
    ...
    function transferFrom(address _from, address _to, uint256 _value) notLocked(_from) returns (bool success) {
